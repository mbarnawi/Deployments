...
def main():
    ...
    # Input form
    st.markdown('<h2 class="input-label">Input Parameters</h2>', unsafe_allow_html=True)
    ...
    if predict:
        ...
        st.markdown(
    f'<div style="background-color: #cce5ff; padding: 10px;">Predicted Car Price: {result[0]}</div>',
    unsafe_allow_html=True
      )
